...
namespace ContactCenter.Data.Migrations
{
    ...
    [Migration("20240913142719_RemoveTicketsTablesMigartion")]
    partial class RemoveTicketsTablesMigartion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContactCenter.Data.Entities.ContactUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ContactCenter.Data.Contact", b =>
                {
                    b.HasOne("ContactCenter.Data.Entities.ContactUser", "ContactUser")
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("ContactCenter.Data.Entities.ContactUser", b =>
                {
                    ...
                    b.HasOne("ContactCenter.Data.User", "User")
                        .WithOne("ContactUser")
                        .HasForeignKey("ContactCenter.Data.Entities.ContactUser", "UserId")
            ...
            modelBuilder.Entity("ContactCenter.Data.Ticket", b =>
                {
                    ...
                    b.HasOne("ContactCenter.Data.Entities.ContactUser", "Creator")
                        .WithMany("Tickets")
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.SetNull);
